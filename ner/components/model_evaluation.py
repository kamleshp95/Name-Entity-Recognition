...
from ner.entity.artifact_entity import (DataTransformationArtifacts,ModelEvaluationArtifacts,ModelTrainingArtifacts)
...
class ModelEvaluation:
    def __init__(self,data_transformation_artifacts: DataTransformationArtifacts, model_training_artifacts: ModelTrainingArtifacts,model_evaluation_config: ModelEvalConfig) -> None:
