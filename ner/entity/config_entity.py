...
class DataTransformationConfig:
    def __init__(self):
        ...
        self.ids_to_labels_gcp_path: str = os.path.join(self.data_transformation_artifacts_dir)
...
class ModelTrainingConfig:
    def __init__(self):
        self.model_training_artifacts_dir: str = os.path.join( ARTIFACTS_DIR, MODEL_TRAINING_ARTIFACTS_DIR)
        ...
        self.tokenizer_file_gcp_path: str = os.path.join(self.model_training_artifacts_dir)
